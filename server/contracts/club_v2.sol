...
contract club_v2 {
    ...
    (string memory _club_title,
        ...
        string memory leader_id, string memory leader_name) {
    ...
    function addMember(address addr, string memory id, string memory name, string memory department) public onlyLeader {
